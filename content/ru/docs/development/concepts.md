...
Классы, отвечающие за работу с параметрами платформы имеют следующую структуру наследования (структура будет подробнее 
разобрана в соответствующей [главе](#структура-классов-платформы)):
- RevitParam:
...
<img src="platform-parameters-1.png" width="300"/>
