...
**Load** - метод класса конфигурации, который производит загрузку конфигурации из файла JSON-формата по указанного пути.
...
2. Изменить файл startup.py, который является точкой входа, указав путь к нужному файлу в JSON-формате.
